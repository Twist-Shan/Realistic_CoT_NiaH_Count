...
if [[ "$MODEL" != "Qwen3-8B" ]]; then
  echo "This first frozen ladder is registered only for Qwen3-8B" >&2
  exit 2
fi
...
ROOT="$REPO/work/v5_native_count_stream/query_mediation_ladder_k128_20d10c_20260821_v1/$MODEL"
