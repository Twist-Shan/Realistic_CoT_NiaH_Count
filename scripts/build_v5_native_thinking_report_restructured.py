...
<details class="appendix-block" open><summary>Appendix E · 其他 grammar 的 attention-map 对应版本（图已展开）</summary><p>正文使用冻结主线 <code>adjacent_rank_after_city</code>。下面把 same-unit rank-before-city 与 structural-invariant bullet 的两类图都直接展开：layer×head atlas 显示 head 在模型中的位置；ordinal×head map 显示正确 target ordinal 在 discovery-ranked heads 上的 attention mass。每张图独立缩放，不能用颜色深浅跨模型或 grammar 比较 raw mass；其作用是检查主线对角 pattern 是否只来自一种表面写法。</p>
<div class="attention-atlas-stack"><figure><h3 class="figure-title">图 E1 · Qwen same-unit rank-before-city · layer×head</h3><div class="attention-atlas-frame"><img src="v5_native_p0_head_atlas/Qwen3-8B_same_unit_rank_before_city_p0_head_map.svg" alt="Qwen same-unit rank-before-city layer by head attention atlas"></div><figcaption>横轴=head，纵轴=layer；颜色=该 grammar 的 discovery exact-P0 target mass。它回答“哪些 heads 亮”，不显示 target ordinal。</figcaption></figure><figure><h3 class="figure-title">图 E2 · Gemma same-unit rank-before-city · layer×head</h3><div class="attention-atlas-frame"><img src="v5_native_p0_head_atlas/Gemma4-E4B_same_unit_rank_before_city_p0_head_map.svg" alt="Gemma same-unit rank-before-city layer by head attention atlas"></div><figcaption>坐标与 E1 同构，但 Gemma 有 42×8 heads，色标独立；不能与 Qwen 色值作绝对比较。</figcaption></figure>
<figure><h3 class="figure-title">图 E3 · Qwen same-unit rank-before-city · ordinal×head</h3><div class="attention-atlas-frame"><img src="v5_native_p0_head_atlas/Qwen3-8B_same_unit_rank_before_city_p0_needle_ordinal_by_head.svg" alt="Qwen same-unit rank-before-city target ordinal by head attention map"></div><figcaption>横轴=discovery-ranked head，纵轴=正确 target record ordinal；颜色=seed-equal raw target mass。它检查同一 head bank 是否跨 occurrence 重复路由。</figcaption></figure><figure><h3 class="figure-title">图 E4 · Gemma same-unit rank-before-city · ordinal×head</h3><div class="attention-atlas-frame"><img src="v5_native_p0_head_atlas/Gemma4-E4B_same_unit_rank_before_city_p0_needle_ordinal_by_head.svg" alt="Gemma same-unit rank-before-city target ordinal by head attention map"></div><figcaption>轴定义同 E3；Gemma 图的 head 数与色标独立。</figcaption></figure>
<figure><h3 class="figure-title">图 E5 · Qwen structural-invariant bullet · layer×head</h3><div class="attention-atlas-frame"><img src="v5_native_p0_head_atlas/Qwen3-8B_structural_invariant_bullet_p0_head_map.svg" alt="Qwen structural-invariant bullet layer by head attention atlas"></div><figcaption>无显式 rank 的 bullet grammar；横轴=head、纵轴=layer。保留该图用于检验 selected heads 是否只锁定显式数字 marker。</figcaption></figure><figure><h3 class="figure-title">图 E6 · Gemma structural-invariant bullet · layer×head</h3><div class="attention-atlas-frame"><img src="v5_native_p0_head_atlas/Gemma4-E4B_structural_invariant_bullet_p0_head_map.svg" alt="Gemma structural-invariant bullet layer by head attention atlas"></div><figcaption>轴定义同 E5，色标在 Gemma panel 内独立。</figcaption></figure>
<figure><h3 class="figure-title">图 E7 · Qwen structural-invariant bullet · ordinal×head</h3><div class="attention-atlas-frame"><img src="v5_native_p0_head_atlas/Qwen3-8B_structural_invariant_bullet_p0_needle_ordinal_by_head.svg" alt="Qwen structural-invariant bullet target ordinal by head attention map"></div><figcaption>横轴=ranked head，纵轴=target ordinal；颜色=20 discovery seeds 的 seed-equal target mass。</figcaption></figure><figure><h3 class="figure-title">图 E8 · Gemma structural-invariant bullet · ordinal×head</h3><div class="attention-atlas-frame"><img src="v5_native_p0_head_atlas/Gemma4-E4B_structural_invariant_bullet_p0_needle_ordinal_by_head.svg" alt="Gemma structural-invariant bullet target ordinal by head attention map"></div><figcaption>轴定义同 E7；只比较空间 pattern，不比较跨模型 raw magnitude。</figcaption></figure></div>
