...
<section id="audit"><h2>复现账本与详细报告</h2><div class="links"><a href="NiaH_Geometry_Comparison.html">Full representation geometry</a><a href="NiaH_Native-Thinking_Causal_Ablation_report.html">Full causal ablation</a><a href="NiaH_Native-Thinking_Parser_and_Token_Sites.html">Parser / token sites</a><a href="v5_native_targeted_retrieval/Qwen3-8B/targeted_retrieval_report.html">Qwen model report</a><a href="v5_native_targeted_retrieval/Gemma4-E4B/targeted_retrieval_report.html">Gemma model report</a></div><p>本页是 synthesis，不替代三份细节报告。Representation 图表只读取 discovery-frozen selected rows；causal 图表只读取 complete registered analysis manifests 与 paired estimands。样本资格审计直接读取完整 trajectory registry，并对 Qwen N≥2 duplicate rows 回查原始 generation 的 <code>rendered_prompt</code>。</p><details><summary>输入文件 SHA256</summary><p class="audit">Generated UTC: {esc(generated)}<br>{ledger}<br>Report schema: realistic_niah_v5_native_thinking_synthesis_v3</p></details><div class="conclusion"><span class="label">审计结论</span>两个 causal manifests 均为 complete，K-grid、anchor registry、五臂完整性与 selection contract 已通过；duplicate 数量、原文 multiplicity 与最终答案对错由 builder 断言，若底层数据改变将拒绝生成报告。</div></section>
</main></div></body></html>"""
