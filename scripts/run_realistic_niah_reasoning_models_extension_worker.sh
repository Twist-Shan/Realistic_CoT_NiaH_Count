...
plan_tsv="${run_root}/orchestration/reasoning_models_extension_shards.tsv"
...
engine_limits_for() {
  case "$1" in
    Nemotron-Nano-v2-9B) echo "4 4" ;;
    Nemotron-3-Nano-4B) echo "6 6" ;;
    Granite-3.3-Instruct-8B) echo "8 8" ;;
    Cogito-v1-Preview-8B) echo "8 8" ;;
    Ministral-3-Instruct-8B) echo "8 8" ;;
    Ministral-3-Reasoning-8B) echo "4 4" ;;
    *)
      echo "No engine limits registered for $1" >&2
      return 2
      ;;
  esac
}
